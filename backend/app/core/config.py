...
class Settings(BaseSettings):
    ...
    BILLING_USAGE_SYNC_ENABLED: bool = False
    BILLING_USAGE_LOOKBACK_DAYS: int = 7
    BILLING_USAGE_GRACE_MINUTES: int = 30
    BILLING_USAGE_BATCH_SIZE: int = 100
    BILLING_USAGE_MAX_RETRIES: int = 5
    BILLING_USAGE_RETRY_BASE_SECONDS: int = 120
    BILLING_USAGE_RETRY_MAX_SECONDS: int = 3600

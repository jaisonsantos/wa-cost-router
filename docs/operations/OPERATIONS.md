...
- **Validação manual temporária**: enquanto o Actions estiver bloqueado, rode `make ci` localmente e anexe o log ao PR para registrar a verificação manual (inclua `pytest`, `npm run lint`/`build` e `make postman-test`).

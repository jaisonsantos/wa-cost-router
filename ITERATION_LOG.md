...
- **current**: Implementar export CSV funcional em Reports (`/reports`) com geração e download dos agregados (ver `IMPLEMENTATION_STATUS.md`).
...
- As prioridades são derivadas dos artefatos `IMPLEMENTATION_STATUS.md`, `MVP_IMPLEMENTATION_STATUS.md` e `docs/ROADMAP.md`.
